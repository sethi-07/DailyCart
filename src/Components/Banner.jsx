...
const Banner = () => {
  return (
    <div className='w-full flex flex-col items-centre justify-center min-h-[543px] bg-linear-to-r from-[#07333b] to-[#136f83] relative'>
      <div className="max-w-7xl mx-auto w-full px-4">
        <div className="flex items-center justify-center w-full h-full">
          <div className='flex flex-col gap-4'>
            ...
            <Link to={"/shop"} className='w-30'><button className='h-8 w-30 bg-green-200 my-5 border-2 rounded-2xl hover:bg-green-400 font-bold transition-all duration-400'>Get Started</button></Link>
          </div>
        </div>
      </div>
    </div>
